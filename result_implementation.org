...
artefact will be discussed in detail.

The artefact developed does to a large extent not use the object
...
the main artefact. After configuration, the only state read is user
